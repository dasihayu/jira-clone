...
const formSchema = z.object({
    name: z.string().trim().min(1, "Name is required").max(256, "Name must be at most 256 characters long"),
    ...
    return (
        <Card className="w-full h-full md:w-[487px] border-none shadow-none">
            ...
            <CardContent className="p-7 flex items-center justify-center">
                <p className="text-sm text-neutral-500">Already have an account? <Link href="/sign-in" className="text-blue-500">Sign in</Link></p>
            </CardContent>
        </Card>
    );
}
